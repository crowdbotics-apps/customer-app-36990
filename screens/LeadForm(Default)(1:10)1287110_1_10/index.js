      ...
      <View style={styles.View_1_849}>
        <View style={styles.View_1_841}>
          <View style={styles.View_1_829}>
            <Text style={styles.Text_1_829}>Provide your details</Text>
          </View>
          <View style={styles.View_1_830}>
            <Text style={styles.Text_1_830}>
        ...
        <View style={styles.View_1_847}>
          <View style={styles.View_1_835}>
            <View style={styles.View_1_832}>
              <Text style={styles.Text_1_832}>Full Name</Text>
            </View>
            <View style={styles.View_1_834}>
              <View style={styles.View_1_833}>
                <Text style={styles.Text_1_833}>e.g. Rahul Malhotra</Text>
              </View>
            </View>
          </View>
          <View style={styles.View_1_837}>
            <View style={styles.View_1_838}>
              <Text style={styles.Text_1_838}>Mobile Number (10 digit)</Text>
            </View>
            <View style={styles.View_1_839}>
              <View style={styles.View_1_840}>
                <Text style={styles.Text_1_840}>e.g. 8888888888</Text>
              </View>
            </View>
          </View>
        </View>
        <View style={styles.View_1_846}>
          <View style={styles.View_1_843}>
            <View style={styles.View_1_842}>
              <Text style={styles.Text_1_842}>Submit</Text>
            </View>
          </View>
          <View style={styles.View_1_844}>
            <View style={styles.View_1_845}>
              <Text style={styles.Text_1_845}>Cancel</Text>
            </View>
          </View>
        </View>
      </View>
