      ...
      <View style={styles.View_1_854}>
        <View style={styles.View_1_855}>
          <View style={styles.View_1_856}>
            <Text style={styles.Text_1_856}>Provide your details</Text>
          </View>
          <View style={styles.View_1_857}>
            <Text style={styles.Text_1_857}>
        ...
        <View style={styles.View_1_858}>
          <View style={styles.View_1_859}>
            <View style={styles.View_1_860}>
              <Text style={styles.Text_1_860}>Full Name</Text>
            </View>
            <View style={styles.View_1_861}>
              <View style={styles.View_1_862}>
                <Text style={styles.Text_1_862}>Rahul Malhotra</Text>
              </View>
            </View>
          </View>
          <View style={styles.View_1_863}>
            <View style={styles.View_1_864}>
              <Text style={styles.Text_1_864}>Mobile Number (10 digit)</Text>
            </View>
            <View style={styles.View_1_865}>
              <View style={styles.View_1_866}>
                <Text style={styles.Text_1_866}>8888888888</Text>
              </View>
            </View>
          </View>
        </View>
        <View style={styles.View_1_867}>
          <View style={styles.View_1_868}>
            <View style={styles.View_1_869}>
              <Text style={styles.Text_1_869}>Submit</Text>
            </View>
          </View>
          <View style={styles.View_1_870}>
            <View style={styles.View_1_871}>
              <Text style={styles.Text_1_871}>Cancel</Text>
            </View>
          </View>
        </View>
      </View>
